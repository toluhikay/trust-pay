    ...
    <div className="lg:py-[100px] lg:px-[120px] md:py-[70px] py-[70px] px-[70px] md:px-[50px]">
      <div className="flex md:flex-row flex-col justify-between items-center">
        <WhyTexts
          ...
          p3={
            "We are committed to changing the status quo and putting together a better experience for our customers."
          }
          ...
          p5={
            "We are providing solutions for financial softwares, to help advance, automate and improve financial services, such that transfer of funds from one account to another, paying bills and purchase of products are made possible."
          }
      ...
      <div className="flex md:flex-row-reverse mt-5 flex-col justify-between items-center">
        <WhyTexts
          p1={"Vision"}
          p2={
            "A simplified network without commercial limits for individuals and businesses to thrive, anytime, anywhere, in Nigeria and beyond."
          }
        />
      ...
      <div className="flex md:flex-row flex-col justify-between items-center">
        <WhyTexts
          p1={"Mission"}
          p2={
            "To create an all-in-one information sharing, socio-economic and political network, with a modern payment infrastructure that would improve digital users experience, introduce and inspire analogue demography, to believe and plug into the global economy."
          }
        />
...
const WhyTexts = ({ p1, p2, p3, p4, p5, p6, p7 }) => {
  return (
    <div
      data-aos="flip-left"
      className="md:w-1/2 w-full md:text-start text-center justify-between"
    >
      <p className="text-[#007CE6] lg:text-[44px] md:text-[30px] text-[25px] mb-6 font-bold">
        {p1}
      </p>
